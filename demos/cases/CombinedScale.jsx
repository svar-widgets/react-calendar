...
import { Cell, Layout } from '@svar-ui/react-layout';
import { relDate } from '../data.js';
import './CombinedScale.css';

const scope = 'wx-aababbSa';
...
export default function CombinedScale() {
  return (
    <Layout>
      <div className={`description ${scope}`}>
        Switch the grouping order to compare Date → Unit with Unit → Date.
        Events assigned to several units are rendered in every matching leaf.
      </div>
      <Cell>
        <Calendar
          events={events}
